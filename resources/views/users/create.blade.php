            ...
            <div class="bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg p-6">
                <form method="POST" action="{{ route('users.store') }}">
                    ...
                    <div class="mb-4">
                        ...
                        <select id="role" name="role" class="block mt-1 w-full border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-300 rounded-md shadow-sm focus:ring-yellow-500 focus:border-yellow-500">
                            <option value="Admin">Admin</option>
                            <option value="Pekerja">Pekerja</option>
                            <option value="Perekrut">Perekrut</option>
                        </select>
